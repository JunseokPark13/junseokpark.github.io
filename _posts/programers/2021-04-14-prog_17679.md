...
![4block_01](https://drive.google.com/uc?export=view&id=1-ww4QhDJ0y-lPL3lhAUOIaA1F3Xtrujn){: width="50%" height="50%"}

만약 판이 위와 같이 주어질 경우, 라이언이 2×2로 배치된 7개 블록과 콘이 2×2로 배치된 4개 블록이 지워진다. 같은 블록은 여러 2×2에 포함될 수 있으며, 지워지는 조건에 만족하는 2×2 모양이 여러 개 있다면 한꺼번에 지워진다.

![4block_02](https://drive.google.com/uc?export=view&id=1RQGFAtZ1HA_4y8XfSIW-AgI83_8geRo0){: width="50%" height="50%"}

블록이 지워진 후에 위에 있는 블록이 아래로 떨어져 빈 공간을 채우게 된다.

![4block_03](https://drive.google.com/uc?export=view&id=1O_p278AaYgFk4s3rGuuP_n8kJFY1_NvJ){: width="50%" height="50%"}

만약 빈 공간을 채운 후에 다시 2×2 형태로 같은 모양의 블록이 모이면 다시 지워지고 떨어지고를 반복하게 된다.

![4block_04](https://drive.google.com/uc?export=view&id=1A1a_ggkKn6Gc245vgUyaqPqNmpsTCSri){: width="50%" height="50%"}
